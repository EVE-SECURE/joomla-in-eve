...
<form action="<?php echo EveRoute::_('userwalletjournal'); ?>" name="adminForm" method="post">
<div>
...
<table>
	<thead>
		<tr>
			...
			<th><?php echo JHTML::_('grid.sort',  'Com_Evewalletjournal_Reason', 'wj.reason', 
					$this->listState->get('list.direction'), $this->listState->get('list.ordering')); ?></th>
			<th><?php echo JHTML::_('grid.sort',  'Com_Evewalletjournal_Character', 'ch.name', 
					$this->listState->get('list.direction'), $this->listState->get('list.ordering')); ?></th>
		</tr>
	</thead>
	<tbody>
	<?php foreach ($this->items as $item) : ?>
		<tr>
			...
			<td><?php echo $this->escape($item->characterName); ?></td>
		</tr>
	<?php endforeach; ?>
	</tbody>
</table>
