...
$plugins = array('eveapi_everesearch');
...
function com_install() {
	...
	$manifestPath = JPATH_ADMINISTRATOR.DS.'components'.DS.'com_everesearch'.DS.'everesearch.xml';
	$version = null;
	...
	switch ($version) {
		...
		default:
			...
			EveHelper::scheduleApiCalls('everesearch', true);
	}
	return true;
}
