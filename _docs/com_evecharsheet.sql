...
('EVE Character Sheet', 'option=com_evecharsheet', 0, 0, 'option=com_evecharsheet', 'EVE Character Sheet', 'com_evecharsheet', 0, 'components/com_eve/assets/icon-16-character.png', 0, '', 1);

DELETE FROM `jos_eve_sections` WHERE `component`='charsheet';
