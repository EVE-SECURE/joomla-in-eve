...
<tr class="<?php echo "row".$this->item->index % 2; ?>">
	...
	<td>
		<input type="checkbox" id="cb<?php echo $this->item->index;?>" name="cid[<?php echo $this->item->index; ?>]" value="<?php echo $this->item->userID; ?>" onclick="isChecked(this.checked);" />
	</td>
	<td>
	<a href="<?php echo $this->item->url; ?>">
		<b><?php echo $this->item->userID; ?></b>
	</a>
	</td>
	<td align="center">
