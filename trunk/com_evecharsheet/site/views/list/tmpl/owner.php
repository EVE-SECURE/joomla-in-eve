...
<ol start="<?php echo $this->pagination->limitstart +1; ?>">
	<?php foreach ($this->characters as $character): ?>
		<li>
			...
			<?php if ($character->corporationID): ?>
				[<a href="<?php echo JRoute::_('index.php?option=com_evecharsheet&view=list&layout=corporation&corporationID='.$character->corporationID); ?>">
