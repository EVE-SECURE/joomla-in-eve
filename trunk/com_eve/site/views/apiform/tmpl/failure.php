...
<?php endif; ?>
<div><?php echo JText::_('ACCOUNT REGISTRATION FAILED'); ?> <br />
<a href="<?php echo JRoute::_(''); ?>"><?php echo JText::_('RETURN HOME'); ?></a>
<?php echo JText::_('OR'); ?> <a
	href="<?php echo JRoute::_('index.php?option=com_eve&view=apiform'); ?>"><?php echo JText::_('REGISTER NEW ACCOUNT'); ?></a>
</div>
