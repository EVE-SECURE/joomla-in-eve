	...
	<table class="adminlist" cellspacing="1">
		<thead>
			<tr>
				...
				<th class="title"><?php echo JHTML::_('grid.sort', JText::_( 'CHARACTER NAME' ), 'c.name', $this->filter_order_dir, $this->filter_order); ?></th>
				<th class="title"><?php echo JHTML::_('grid.sort', JText::_( 'OWNER' ), 'userName', $this->filter_order_dir, $this->filter_order); ?></th>
				<th class="title"><?php echo JHTML::_('grid.sort', JText::_( 'CORPORATION' ), 'co.corporationName', $this->filter_order_dir, $this->filter_order); ?></th>
				<th class="title"><?php echo JHTML::_('grid.sort', JText::_( 'ALLIANCE' ), 'allianceName', $this->filter_order_dir, $this->filter_order); ?></th>
			</tr>
		</thead>
		<tfoot>
			<tr>
