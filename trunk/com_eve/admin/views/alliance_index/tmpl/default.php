	...
	<table class="adminlist" cellspacing="1">
		<thead>
			<tr>
				...
				<th class="title"><?php echo JHTML::_('grid.sort', JText::_( 'ALLIANCE NAME' ), 'al.name', $this->filter_order_dir, $this->filter_order); ?></th>
				<th class="title"><?php echo JHTML::_('grid.sort', JText::_( 'ALLIANCE TAG' ), 'al.alliance_tag', $this->filter_order_dir, $this->filter_order); ?></th>
				<th class="title"><?php echo JHTML::_('grid.sort', JText::_( 'STANDINGS' ), 'al.standings', $this->filter_order_dir, $this->filter_order); ?></th>
