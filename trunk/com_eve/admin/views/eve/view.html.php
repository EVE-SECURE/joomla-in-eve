...
class EveViewEve extends JView {
	...
	public function display($tpl = null) {
		...
		$ownerCorporations = $this->get('OwnerCorporations');
		...
		$this->assignRef('ownerCorporations', $ownerCorporations);
...
<div class="icon"><a href="<?php echo $link; ?>"> <?php echo JHTML::_('image', 'administrator/components/com_eve/assets/' . $image , NULL, NULL, $text ); ?>
...
<div class="icon"><a href="<?php echo $link; ?>"
	rel="{handler: 'iframe', size: {x: 640, y: 480}}" class="modal"> <?php echo JHTML::_('image.site',  $image, '/templates/'. $template .'/images/header/', NULL, NULL, $text ); ?>
<span><?php echo $text; ?></span></a></div>
</div>
		<?php
	}
