...
/* fix for "fn.create is not a function" error */
Autocompleter.Base.prototype.fireEvent = function(type, args, delay){
	if (this.$events && this.$events[type]){
		this.$events[type].each(function(fn){
			if (fn.create) fn.create({'bind': this, 'delay': delay, 'arguments': args})();
		}, this);
	}
	return this;
}
