...
class EveModelAccounts extends JModelList {
	...
	protected function _getListQuery()
	{
		...
		$q->addJoin('#__users', 'editor', 'u.checked_out=editor.id');
	...
	protected function _populateState() {
		...
		$this->setState('list.ordering', $app->getUserStateFromRequest($context.'list.ordering', 'filter_order', 'owner.name', 'cmd'));
