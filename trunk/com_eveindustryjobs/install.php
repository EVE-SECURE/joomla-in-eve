...
$plugins = array('eveapi_eveindustryjobs');
...
function com_install() {
	...
	$manifestPath = JPATH_ADMINISTRATOR.DS.'components'.DS.'com_eveindustryjobs'.DS.'eveindustryjobs.xml';
	$version = null;
	...
	switch ($version) {
		...
		default:
			...
			EveHelper::scheduleApiCalls('eveindustryjobs', true);
	}
	return true;
}
