...
('EVE Character Tracking', 'option=com_evechartracking', 0, 0, 'option=com_evechartracking', 'EVE Character Tracking', 'com_evechartracking', 0, 'components/com_eve/assets/icon-16-corporation.png', 0, '', 1);
