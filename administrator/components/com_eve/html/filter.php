...
class JHTMLFilter {
	...
	function search($value) {
		...
		'<input type="text" name="search" id="search" value="'.$value.'" class="text_area" onchange="document.adminForm.submit();" />'.
		'<button onclick="this.form.submit();">'.JText::_( 'Go' ).'</button>'.
		'<button onclick="document.getElementById(\'search\').value=\'\';this.form.getElementById(\'filter_catid\').value=\'0\';this.form.getElementById(\'filter_state\').value=\'\';this.form.submit();">'.JText::_( 'Reset' ).'</button>';
