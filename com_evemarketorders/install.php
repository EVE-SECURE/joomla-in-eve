...
$plugins = array('eveapi_evemarketorders');
...
function com_install() {
	...
	$manifestPath = JPATH_ADMINISTRATOR.DS.'components'.DS.'com_evemarketorders'.DS.'evemarketorders.xml';
	$version = null;
	...
	switch ($version) {
		case '0.5':
		case '0.6':
			$sql = "ALTER TABLE `#__eve_marketorders` CHANGE `orderID` `orderID` BIGINT( 20 ) NOT NULL ,".
		...
		default:
			...
			EveHelper::scheduleApiCalls('evemarketorders', true);
	}
	return true;
}
